...
class Ui_LinuxAgentUI(object):
    def setupUi(self, LinuxAgentUI):
        ...
        LinuxAgentUI.resize(313, 190)
        LinuxAgentUI.setMinimumSize(QtCore.QSize(313, 190))
        LinuxAgentUI.setMaximumSize(QtCore.QSize(313, 190))
        ...
        self.getPasswordSettingBtn = QtWidgets.QPushButton(LinuxAgentUI)
        self.getPasswordSettingBtn.setGeometry(QtCore.QRect(10, 100, 291, 23))
        self.getPasswordSettingBtn.setObjectName("getPasswordSettingBtn")
        self.getPasswordInfoBtn = QtWidgets.QPushButton(LinuxAgentUI)
        self.getPasswordInfoBtn.setGeometry(QtCore.QRect(10, 130, 291, 23))
        self.getPasswordInfoBtn.setObjectName("getPasswordInfoBtn")
        self.getSerialNumberBtn = QtWidgets.QPushButton(LinuxAgentUI)
        self.getSerialNumberBtn.setGeometry(QtCore.QRect(10, 160, 291, 23))
        self.getSerialNumberBtn.setObjectName("getSerialNumberBtn")
    ...
    def retranslateUi(self, LinuxAgentUI):
        ...
        LinuxAgentUI.setWindowTitle(_translate("LinuxAgentUI", "Form"))
        ...
        self.getPasswordSettingBtn.setText(_translate("LinuxAgentUI", "Local Password Setting"))
        self.getPasswordInfoBtn.setText(_translate("LinuxAgentUI", "Password Information"))
        self.getSerialNumberBtn.setText(_translate("LinuxAgentUI", "Serial Number"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    LinuxAgentUI = QtWidgets.QWidget()
    ui = Ui_LinuxAgentUI()
    ui.setupUi(LinuxAgentUI)
    LinuxAgentUI.show()
    sys.exit(app.exec_())
